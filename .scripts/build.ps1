...
$builder = [BuildProject]::new("DualSpecSystem", $srcDirectory, $sdkPath, $gamePath)
...
# &"$ScriptDirectory\X2ProjectGenerator.exe" @("$srcDirectory\DualSpecSystem", "--exclude-contents", "--verify-only")
